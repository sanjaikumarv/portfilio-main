                    ...
                    <div key={skillIndex}>
                      ...
                      <div className='w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5'>
                        <motion.div
                          ...
                          className='h-2.5 rounded-full bg-gradient-to-r from-purple-600 to-pink-600'></motion.div>
                      </div>
                    </div>
                  ))}
                </div>
