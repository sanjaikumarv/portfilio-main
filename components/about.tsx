...
export default function About() {
  ...
  const qualities = [
    ...
    },
    {
      ...
      title: "Team Player",
      description:
        "I collaborate effectively with teams to achieve project goals.",
    },
    {
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
            ...
            <motion.div
              ...
              <p className='text-lg text-gray-700 dark:text-gray-300 mb-6'>
                ...
                programming experience and 3+ years of professional work. My
                journey in the world of development has equipped me with a
                diverse skill set and a deep understanding of both frontend and
                backend technologies.
              </p>
              <p className='text-lg text-gray-700 dark:text-gray-300 mb-8'>
                I specialize in building robust web applications using modern
                technologies like React, Next.js, Node.js, and more. I enjoy
