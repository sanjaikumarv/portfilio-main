          ...
          >
            ...
            >
              <h2 className="text-2xl md:text-3xl font-medium text-gray-700 dark:text-gray-300 mb-6">
                I&apos;m a <span ref={typingRef} className="text-purple-600"></span>
            ...
            >
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-2xl">
                With 4+ years of programming experience and 3+ years of professional work, I&apos;m passionate about
                exploring new technologies and collaborating with enthusiastic, innovative people. Let&apos;s build and
                create together!
              </p>
            </motion.div>
            ...
            >
              <Link href="https://github.com/sanjaikumarv" target="_blank" rel="noopener noreferrer">
                <Button
                  variant="outline"
              ...
              <Link href="https://www.linkedin.com/in/sanjaikumarv" target="_blank" rel="noopener noreferrer">
                <Button
                  variant="outline"
                  className="gap-2 rounded-full hover:bg-purple-100 dark:hover:bg-purple-900 hover:text-purple-600 dark:hover:text-purple-300 transition-all duration-300 hover:scale-105"
                >
            ...
            >
              <Link href="https://drive.google.com/file/d/12ZQQKcYSI1btIHU-Sbp5DydRvbOWmlpg/view?usp=sharing" target="_blank" rel="noopener noreferrer">
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              ...
              <div className="absolute inset-1 rounded-full overflow-hidden bg-white dark:bg-gray-900">
                <Image src="/avator.png" alt="Sanjaikumar Veerasamy" fill className="object-cover" />
              </div>
            </div>
          </motion.div>
        </div>
